...
exports.getDockerComposeServices = void 0;
const PREFIX = 'dchc';
const MY_SERVICES = {};
const DEFAULTS = {
    'enable': 'false',
...
function getDockerComposeServices(doc) {
    for (const [key, value] of Object.entries(doc.services)) { // for every service
        MY_SERVICES[key] = Object.assign({}, DEFAULTS); // add key to MY_SERVICES with default values
...
exports.getDockerComposeServices = getDockerComposeServices;
